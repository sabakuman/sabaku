...
#define STRING_CONFIG_H_AUTHOR "Sabaku Sindewinder X1" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  21.60
    #define DEFAULT_Ki   1.55
    #define DEFAULT_Kd 75.17
  #endif
#endif // PIDTEMP
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 70, -25, 0 }
